...
class Logger(object):
    ...
    def log(self,
        ...
        """
        if drone < 0 or drone >= self.NUM_DRONES or timestamp < 0 or (len(state) != 20 and len(state) != 22) or len(control) != 12:
            print("[ERROR] in Logger.log(), invalid data", len(state), len(control))
